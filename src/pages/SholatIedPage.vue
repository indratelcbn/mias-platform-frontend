<template>
  <q-page class="galeri-page">
    ...
    <div class="galeri-hero q-pa-xl text-center text-white">
      ...
      <div class="text-h3 text-weight-bold q-mb-sm">Sholat Ied</div>
      <div class="text-subtitle1" style="opacity: .85">
        Dokumentasi foto Sholat Ied Masjid Imam Asy Syafi'i
      </div>
    </div>
      ...
      <template v-else>
        <div class="text-center q-py-xl">
          ...
          <div class="text-body2 text-grey-5 q-mt-sm">
            Dokumentasi Sholat Ied akan segera tersedia.
          </div>
        </div>
      </template>
